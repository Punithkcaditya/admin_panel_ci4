		...
		<div class="col-md-12">
			<div class="card shadow">
				<div class="card-header">
					<h2 class="mb-5 text-center">SSJL - Introduction -KYC Form</h2>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-row mb-4">
									<label for="date" class="col-3 col-sm-2 col-md-3 col-lg-2 col-form-label">Date:</label>
								...
								<div class="form-row mb-4">
									...
									<div class="col-9 col-sm-10 col-md-9 col-lg-10">
										<input type="text" class="form-control" name="ssjl_uan_no" placeholder="UAN No" value="" required>
									</div>
								</div>
								<div class="form-row mb-4">
									<label for="ssjl_adhaar_no" class="col-3 col-sm-2 col-md-3 col-lg-2 col-form-label">AADHAR No :</label>
									<div class="col-9 col-sm-10 col-md-9 col-lg-10">
										<input type="text" class="form-control" name="ssjl_adhaar_no" placeholder="AADHAR No" value="" required>
									</div>
								</div>
								<div class="form-row mb-4">
								...
								<div class="form-row mb-4">
									...
									<div class="col-9 col-sm-10 col-md-9 col-lg-10">
										<input type="text" class="form-control" name="ssjl_emergency_contact_person" placeholder="Mobile" value="" required>
									</div>
								</div>
								<div class="form-row mb-4">
									<label for="ssjl_reference_person" class="col-3 col-sm-2 col-md-3 col-lg-2 col-form-label">Reference Person:</label>
									<div class="col-9 col-sm-10 col-md-9 col-lg-10">
										<input type="text" class="form-control" name="ssjl_reference_person" placeholder="Reference Person" value="" required>
									</div>
								</div>
								<div class="form-row mb-4">
									<label for="ssjl_health_issue_any" class="col-3 col-sm-2 col-md-3 col-lg-2 col-form-label">Health Issue If any:</label>
									<div class="col-9 col-sm-10 col-md-9 col-lg-10">
										<input type="text" class="form-control" name="ssjl_health_issue_any" placeholder="Health Issue If any" value="" required>
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="form-row mb-4">
									<div class="col-9 col-sm-10 col-md-9 col-lg-10">
										<input type="file" id="image" name="ssl_profile_pic">
										<img id="preview" src="<?= base_url("uploads/save_latest.png") ?> " alt="Preview">
									</div>
								</div>
								...
								<div class="form-row mb-4">
									...
									<div class="col-9 col-sm-10 col-md-9 col-lg-10">
										<input class="form-control" name="ssjl_bank_ac_no" placeholder="Bank AC/ No" type="text" required>
									</div>
								</div>
								<div class="form-row mb-4">
											...
											<div class="col-md-6">
												<div class="form-row mb-4">
													...
													<div class="col-7 col-sm-7 col-md-7 col-lg-7">
														<input type="file" name="ssjl_resume" class="dropify" data-height="300" required />
													</div>
												</div>
												...
												<div class="form-row mb-4">
													...
													<div class="col-7 col-sm-7 col-md-7 col-lg-7">
														<input type="file" name="ssjl_adhaar_copy" class="dropify" data-height="300" required />
													</div>
												</div>
												...
												<div class="form-row mb-4">
													...
													<div class="col-7 col-sm-7 col-md-7 col-lg-7">
														<input type="file" name="ssjl_releiving_letter" class="dropify" data-height="300" required />
													</div>
												</div>
												...
												<div class="form-row mb-4">
													...
													<div class="col-7 col-sm-7 col-md-7 col-lg-7">
														<input type="file" name="ssjl_education_documents" class="dropify" data-height="300" required />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-row mb-4">
													...
													<div class="col-7 col-sm-7 col-md-7 col-lg-7">
														<input type="file" name="ssjl_pan_copy" class="dropify" data-height="300" required />
													</div>
												</div>
												...
												<div class="form-row mb-4">
													...
													<div class="col-7 col-sm-7 col-md-7 col-lg-7">
														<input type="file" name="ssjl_previous_pay_slips" class="dropify" data-height="300" required />
													</div>
												</div>
												...
												<div class="form-row mb-4">
													...
													<div class="col-7 col-sm-7 col-md-7 col-lg-7">
														<input type="file" name="ssjl_rent_agreement" class="dropify" data-height="300" required />
													</div>
												</div>
											</div>
