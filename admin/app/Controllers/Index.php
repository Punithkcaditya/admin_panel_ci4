...
class Index extends BaseController
{
    ...
    public function index()
    {
        ...
        if (!empty($input)) {
            ...
            if (!empty($login_detail)) {
                ...
                $checkEmployee = $this->introductionform_model
                    ->where("ssjl_email", $email)
                    ->countAllResults();
                ...
                if ($checkEmployee == 0 && $checkRole > 0) {
    ...
    public function addemployeedetails()
    {
        ...
        $input = $this->validate([
            ...
            "ssjl_emergency_contact_person" => "required",
            "ssjl_reference_person" => "required",
            "ssjl_health_issue_any" => "required",
        ...
        if (!empty($input)) {
            ...
            if ($this->request->getMethod() == "post") {
                ...
                if ($ssjl_education_documents->isValid() && !$ssjl_education_documents->hasMoved()) {
                    $name = $ssjl_education_documents->getRandomName();
                    $ext = $ssjl_education_documents->getClientExtension();
                    $ssjl_education_documents_pic =  $name;
                    $ssjl_education_documents->move("admin/uploads/", $ssjl_education_documents_pic);
                    $filepath = base_url() . "/uploads/" . $ssjl_education_documents_pic;
                    session()->setFlashdata("filepath", $filepath);
                    session()->setFlashdata("extension", $ext);
                    $udata["ssjl_education_documents"] = $ssjl_education_documents_pic;
                }
                ...
                if ($ssjl_pan_copy->isValid() && !$ssjl_pan_copy->hasMoved()) {
                    $name = $ssjl_pan_copy->getRandomName();
                    $ext = $ssjl_pan_copy->getClientExtension();
                    $ssjl_pan_copy_pic =  $name;
                    $ssjl_pan_copy->move("admin/uploads/", $ssjl_pan_copy_pic);
                    $filepath = base_url() . "/uploads/" . $ssjl_pan_copy_pic;
                    session()->setFlashdata("filepath", $filepath);
                    session()->setFlashdata("extension", $ext);
                    $udata["ssjl_pan_copy"] = $ssjl_pan_copy_pic;
                }
                ...
                if ($ssjl_releiving_letter->isValid() && !$ssjl_releiving_letter->hasMoved()) {
                    $name = $ssjl_releiving_letter->getRandomName();
                    $ext = $ssjl_releiving_letter->getClientExtension();
                    $ssjl_releiving_letter_pic =  $name;
                    $ssjl_releiving_letter->move("admin/uploads/", $ssjl_releiving_letter_pic);
                    $filepath = base_url() . "/uploads/" . $ssjl_releiving_letter_pic;
                    session()->setFlashdata("filepath", $filepath);
                    session()->setFlashdata("extension", $ext);
                    $udata["ssjl_releiving_letter"] = $ssjl_releiving_letter_pic;
                }
                ...
                if ($ssjl_resume->isValid() && !$ssjl_resume->hasMoved()) {
                    $name = $ssjl_resume->getRandomName();
                    $ext = $ssjl_resume->getClientExtension();
                    $ssjl_resume_pic =  $name;
                    $ssjl_resume->move("admin/uploads/", $ssjl_resume_pic);
                    $filepath = base_url() . "/uploads/" . $ssjl_resume_pic;
                    session()->setFlashdata("filepath", $filepath);
                    session()->setFlashdata("extension", $ext);
                    $udata["ssjl_resume"] = $ssjl_resume_pic;
                }
                ...
                if ($ssl_profile_pic->isValid() && !$ssl_profile_pic->hasMoved()) {
                    $name = $ssl_profile_pic->getRandomName();
                    $ext = $ssl_profile_pic->getClientExtension();
                    $ssl_profile_pic_pic =  $name;
                    $ssl_profile_pic->move("admin/uploads/", $ssl_profile_pic_pic);
                    $filepath = base_url() . "/uploads/" . $ssl_profile_pic_pic;
                    session()->setFlashdata("filepath", $filepath);
                    session()->setFlashdata("extension", $ext);
                    $udata["ssl_profile_pic"] = $ssl_profile_pic_pic;
                }
                ...
                if ($ssjl_adhaar_copy->isValid() && !$ssjl_adhaar_copy->hasMoved()) {
                    $name = $ssjl_adhaar_copy->getRandomName();
                    $ext = $ssjl_adhaar_copy->getClientExtension();
                    $ssjl_adhaar_copy_pic =  $name;
                    $ssjl_adhaar_copy->move("admin/uploads/", $ssjl_adhaar_copy_pic);
                    $filepath = base_url() . "/uploads/" . $ssjl_adhaar_copy_pic;
                    session()->setFlashdata("filepath", $filepath);
                    session()->setFlashdata("extension", $ext);
                    $udata["ssjl_adhaar_copy"] = $ssjl_adhaar_copy_pic;
                }
                ...
                if ($ssjl_previous_pay_slips->isValid() && !$ssjl_previous_pay_slips->hasMoved()) {
                    $name = $ssjl_previous_pay_slips->getRandomName();
                    $ext = $ssjl_previous_pay_slips->getClientExtension();
                    $ssjl_previous_pay_slips_pic =  $name;
                    $ssjl_previous_pay_slips->move("admin/uploads/", $ssjl_previous_pay_slips_pic);
                    $filepath = base_url() . "/uploads/" . $ssjl_previous_pay_slips_pic;
                    session()->setFlashdata("filepath", $filepath);
                    session()->setFlashdata("extension", $ext);
                    $udata["ssjl_previous_pay_slips"] = $ssjl_previous_pay_slips_pic;
                }
                ...
                if ($ssjl_rent_agreement->isValid() && !$ssjl_rent_agreement->hasMoved()) {
                    $name = $ssjl_rent_agreement->getRandomName();
                    $ext = $ssjl_rent_agreement->getClientExtension();
                    $ssjl_rent_agreement_pic =  $name;
                    $ssjl_rent_agreement->move("admin/uploads/", $ssjl_rent_agreement_pic);
                    $filepath = base_url() . "/uploads/" . $ssjl_rent_agreement_pic;
                    session()->setFlashdata("filepath", $filepath);
                    session()->setFlashdata("extension", $ext);
                    $udata["ssjl_rent_agreement"] = $ssjl_rent_agreement_pic;
                }
                ...
                $udata["ssjl_emergency_contact_person"] = $ssjl_emergency_contact_person;
                $udata["ssjl_reference_person"] = $ssjl_reference_person;
                $udata["ssjl_health_issue_any"] = $ssjl_health_issue_any;
