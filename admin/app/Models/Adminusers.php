...
class Adminusers extends Model
{
    ...
    public function loginnew( $data) { 
        ...
        if(!empty($result1)){
            ...
            $sql = 'SELECT a.*   FROM ' . $this->table . ' a LEFT JOIN admin_roles ar ON a.role_id = ar.role_id where a.role_id = ' .$id1->role_id. ' AND  a.password = "' .md5($data['password']). '"  AND a.email = "'.$data['email'].'"'; 
